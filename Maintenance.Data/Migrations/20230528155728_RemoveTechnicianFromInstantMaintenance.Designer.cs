...
namespace Maintenance.Data.Migrations
{
    ...
    [Migration("20230528155728_RemoveTechnicianFromInstantMaintenance")]
    partial class RemoveTechnicianFromInstantMaintenance
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Maintenance.Data.DbEntities.InstantMaintenanceItem", b =>
                {
                    ...
                    b.Property<int>("InstantMaintenanceId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("InstantMaintenanceId");
            ...
            modelBuilder.Entity("Maintenance.Data.DbEntities.ReturnHandReceiptItem", b =>
                {
                    ...
                    b.Property<int>("HandReceiptItemId")
                        .HasColumnType("int");

                    b.Property<bool>("IsDelete")
                        .HasColumnType("bit");

                    b.Property<bool>("IsReturnItemWarrantyValid")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Maintenance.Data.DbEntities.InstantMaintenanceItem", b =>
                {
                    b.HasOne("Maintenance.Data.DbEntities.Branch", "Branch")
                        .WithMany("InstantMaintenanceItems")
                        .HasForeignKey("BranchId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Maintenance.Data.DbEntities.InstantMaintenance", "InstantMaintenance")
                        .WithMany("InstantMaintenanceItems")
                        .HasForeignKey("InstantMaintenanceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("InstantMaintenance");
            ...
            modelBuilder.Entity("Maintenance.Data.DbEntities.ReturnHandReceiptItem", b =>
                {
                    ...
                    b.HasOne("Maintenance.Data.DbEntities.HandReceiptItem", "HandReceiptItem")
                        ...
                        .HasForeignKey("Maintenance.Data.DbEntities.ReturnHandReceiptItem", "HandReceiptItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Maintenance.Data.DbEntities.Branch", b =>
                {
                    ...
                    b.Navigation("InstantMaintenanceItems");

                    b.Navigation("InstantMaintenances");
            ...
            modelBuilder.Entity("Maintenance.Data.DbEntities.HandReceiptItem", b =>
                {
                    b.Navigation("ReturnHandReceiptItem")
                        .IsRequired();
                });
